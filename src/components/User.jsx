...
import { FiUserX, FiEdit, FiInfo, FiMoreVertical, FiMoreHorizontal, FiCornerDownLeft } from "react-icons/fi";
    ...
    <div className='user'>
      ...
      <div className="user--menu">
        ...
        <section className='menu--icon'>
          <FiUserX/>
          <Link to='../user-edit'><FiEdit/></Link>
          <Link to='../user-info'><FiInfo/></Link>
        </section>
      </div>
      <div className="user--delete--confirmation">
        <section className='delete'>
          <button className='delete--button'>
            <span className='message--sure'>
              Are you sure?
            </span>
